...
const CalendarApp = () => {
  ...
  const [currentMonth, setCurrentMonth] = useState(currendDate.getMonth());
  const [currentYear, setCurrentYear] = useState(currendDate.getFullYear());
    ...
    <div className="calendar-app">
      ...
      <div className="events">
        <div className="event-popup">
          ...
          <textarea name="" placeholder="Enter Event Text " id=""></textarea>
